...
void init_display(){
	...
	GPIOB->OSPEEDR |= (GPIO_OSPEEDR_OSPEED12|GPIO_OSPEEDR_OSPEED13|GPIO_OSPEEDR_OSPEED14|GPIO_OSPEEDR_OSPEED15|GPIO_OSPEEDER_OSPEEDR2);		
	GPIOB->PUPDR &= ~(GPIO_OTYPER_OT12|GPIO_OTYPER_OT13|GPIO_OTYPER_OT14|GPIO_OTYPER_OT15|GPIO_OTYPER_OT2);
